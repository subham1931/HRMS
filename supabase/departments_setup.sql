...
-- Departments master table for HR module.
...
drop policy if exists "HR admins can read departments" on public.departments;
create policy "HR admins can read departments"
